            ...
            <div className='col py-2 px-4'>
                <Form>
                    <Form.Group className='mb-3'>
                        ...
                        <Form.Control disabled name='codigo' value={modelAlumnos.codigo} onChange={handleChange} type='number' placeholder="Ingrese codigo del alumno"></Form.Control>
                    </Form.Group>
                    <Form.Group className='mb-3'>
                    ...
                    <Form.Group className='mb-3'>
                        ...
                        <Form.Select name='grado' value={modelAlumnos.grado} onChange={handleChange}>
                            <option value={''} disabled >Seleccione el grado del alumno</option>
                    ...
                    <Form.Group className='mb-3'>
                        ...
                        <Form.Select name='becaid' value={modelAlumnos.becaid} onChange={handleChange}>
                    ...
                    <Form.Group className='mb-3 d-flex gap-2'>
                        <Button className='col' variant="danger" type="button" onClick={handleCloseAlumnosModal}>
                            Cancelar
                        </Button>
