...
import Body from './cancelacionMatricula/body'

function CancelacionMatricula() {
                ...
                <Row>
                    ...
                    <Col className="min-vh-100 min-vh d-flex px-5 py-4" xs sm={9} md={9} lg={9} xl={10} >
                        <div className='d-flex flex-column w-100 align-items-center gap-4'>
                            <HeaderTitle titulo="Cancelacion de Matrícula" usuario="Admin" />
                            <Body></Body>
                        </div>
                    </Col>
                </Row>
...
export default CancelacionMatricula;